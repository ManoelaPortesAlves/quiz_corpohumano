...
const resp_questao = document.getElementById("resp_questao");
...
function showQuetions(index) {
  ...
  document.getElementById("que_img").src=que_img
...
function optionSelected(answer) {
  ...
  if (userAns == correcAns) {
    ...
    resp_questao.innerHTML = "Resposta correta! Parabéns pelo empenho e vamos pra próxima!"
  } else {
    resp_questao.innerHTML = "Hmm, não é bem isso! Que tal revisar esse tema e responder novamente?"
      }
